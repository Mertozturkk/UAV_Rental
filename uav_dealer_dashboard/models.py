...
class uavDealer(models.Model):
    uav_dealer = models.OneToOneField(User, on_delete=models.CASCADE)
...
class Vehicles(models.Model):
    uav_name = models.CharField(max_length=20)
    color = models.CharField(max_length=10)
    dealer = models.ForeignKey(uavDealer, on_delete=models.PROTECT)
